...
<body>
    <!-- NAVBAR -->
<!-- NAVBAR - TAMBAHKAN LINK ADMIN LOGIN -->
<nav class="navbar navbar-expand-lg">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <?php else: ?>
                    <!-- TOMBOL LOGIN ADMIN -->
                    <li class="nav-item ms-2">
                        <a href="admin_login.php" class="btn btn-outline-primary btn-rounded">
    ...
    <?php if (isLoggedIn()): ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <!-- UBAH JADI LOGIN UNTUK DAFTAR -->
        <a href="login_user.php" class="btn btn-gold btn-rounded" style="padding: 0.875rem 2rem;">
            <i class="fa fa-sign-in-alt me-1"></i> Login untuk Daftar
        </a>
    <?php endif; ?>
</div>
